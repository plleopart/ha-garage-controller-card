...
open_switch: switch.porta_carretera_tanca_relay
...
| `open_switch` | no | `switch.porta_carretera_tanca_relay` | Switch used to start opening. Used to detect unavailable control state. |
